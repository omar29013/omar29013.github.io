...
document.getElementById("up").addEventListener("click", () => KEY.setDirection("up"));
document.getElementById("down").addEventListener("click", () => KEY.setDirection("down"));
document.getElementById("left").addEventListener("click", () => KEY.setDirection("left"));
document.getElementById("right").addEventListener("click", () => KEY.setDirection("right"));
